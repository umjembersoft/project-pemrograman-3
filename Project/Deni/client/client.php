      ...
      <?php
        ...
        if (isset($_GET['op']))
        {
            if ($_GET['op'] == 'search')
            {
                ...
                $client = new nusoap_client('http://localhost/buku/server/server.php');
                ...
                {
                    echo "<table border='1'>";
                    echo "<tr><th>NOMOR</th><th>NAMA BUKU</th><th>HARGA</th></tr>";
                    foreach($result as $data)
                    {
                        echo "<tr><td>".$data['noBuku']."</td><td>".$data['namaBuku']."</td><td>".$data['harga']."</td></tr>";
                    }
                    echo "</table>";
